...
//        tweet1.setMentionedBy(Arrays.asList(user1, user2));
...
//        tweet5.setMentionedBy(Arrays.asList(user1, user2));
...
//        tweet6.setMentionedBy(Arrays.asList(user1, user2));
...
//        deletedTweet.setMentionedBy(Arrays.asList(user1, user2));
